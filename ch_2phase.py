...
# Initial condition
u.x.array[:] = 0.0
rng = np.random.default_rng(MPI.COMM_WORLD.Get_rank() + 2)
...
with io.VTXWriter(domain.comm, filename, [c_out], engine="BP4") as vtx:
    # Project initial condition
    c_out.interpolate(u.sub(0))
    vtx.write(t)
